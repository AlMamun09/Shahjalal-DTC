            ...
            <RevealSection key={course.id} delay={i * 150}>
              <div className="card-hover bg-white rounded-2xl p-8 shadow-sm border border-gray-100 group relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <Link to="/enroll" className="inline-flex items-center gap-2 text-brand-red font-semibold text-sm group/link">
                    {t('courses.enroll')}
        ...
        {courses.length > 0 && (
          <RevealSection>
            <div className="text-center mt-10">
              <Link to="/courses" className="inline-flex items-center gap-2 text-brand-red font-semibold hover:gap-3 transition-all">
                {t('courses.see_all')} <span>→</span>
              </Link>
            </div>
          </RevealSection>
        )}
