...
- **Motion**: CSS-only or Motion library (React). Staggered reveals, scroll-triggering, hover states.
...
NEVER use generic AI aesthetics: overused fonts (Inter, Roboto, Arial), purple gradients, predictable layouts.
